...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        btnRestaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMap.clear();
                String url = getUrl(20.735008, -103.454912, Restaurant);
        ...
        btnHospital.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("onClick", "Button is Clicked");
                mMap.clear();
                String url = getUrl(20.735008, -103.454912, Hospital);
                Object[] DataTransfer = new Object[2];
                DataTransfer[0] = mMap;
                DataTransfer[1] = url;
                Log.d("onClick", url);
                GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData();
                getNearbyPlacesData.execute(DataTransfer);
                Toast.makeText(MapsActivity.this,"Nearby Nutritionists", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDyCXuW7EaY6Ovq5DCDYye9jKy-SKdFHBg");
